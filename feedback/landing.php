...
?>
    ...
    <img src="./img/favicon.png" class="w-25 mb-3" alt="">
    <h2>Feedback</h2>
    <?php echo isset($name) ? $name : ''; ?>
    <p class="lead text-center">Leave feedback for Arash's Project ( this one pls ) </p>
    ...
    <form method="POST" action="<?php echo htmlspecialchars(
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control <?php echo !$bodyErr ?:
          'is-invalid'; ?>" id="body" name="body" placeholder="Enter your feedback ( dw we wont come to arrest u )"><?php echo $body; ?></textarea>
      </div>
      <div class="mb-3">
